...
import ActionButton from 'src/capp/widget-components/action/actionbutton';
import Document from 'src/capp/widget-components/data/document';
import ShowcaseCarousel from 'src/capp/widget-components/showcase/showcasecarousel';
import ShowcaseImage from 'src/capp/widget-components/showcase/showcaseimage';
import ShowcaseVideo from 'src/capp/widget-components/showcase/showcasevideo';
import Story from 'src/capp/widget-components/showcase/story';
import Heading from 'src/capp/widget-components/text/heading';
import Subheading from 'src/capp/widget-components/text/subheading';
import Textblock from 'src/capp/widget-components/text/textblock';

import { _components } from 'src/_mock';
import { useDesign } from 'src/hooks/use-design';
import Labels from 'src/capp/widgets/basic/certificates/certificates';
import CustomWidget from 'src/capp/widgets/basic/customwidget';
import FooterWidget from 'src/capp/widgets/required/footer';
import ProductHead from 'src/capp/widgets/required/product-head';
import ProductInfo from 'src/capp/widgets/required/product-info/product-info';
import Messe from 'src/capp/widgets/retention/messe';
import Patos from 'src/capp/widgets/retention/patos';
import Storefinder from 'src/capp/widgets/retention/storefinder/storefinder';
import Origin from 'src/capp/widgets/sustainability/origin/origin';
import Recycling from 'src/capp/widgets/sustainability/recycling/recycling';
import Sustainability from 'src/capp/widgets/sustainability/sustainability/sustainability';
