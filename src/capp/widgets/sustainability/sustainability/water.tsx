...
import { _nutriReference } from 'src/capp/_mock/_nutriReference';
import CHeading from 'src/capp/custom-components/c-heading';
import CPara from 'src/capp/custom-components/c-para';
import { useBoolean } from 'src/hooks/use-boolean';
import CStackedBar from 'src/capp/custom-components/c-stackedbar';
import { formatNumberToGerman } from 'src/utils/format-number';
import CAccordionSub from 'src/capp/custom-components/c-accordion-sub';
import CButton from 'src/capp/custom-components/c-button';
