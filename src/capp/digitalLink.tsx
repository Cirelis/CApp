...
import { getProductLive, useGetProductGtin } from 'src/api/product/live';
import { useGetEvents } from 'src/api/matomo';
import { _paymentPlans } from 'src/_mock/_paymentPlans';
import { paths } from 'src/routes/paths';
import FunnelView from 'src/capp/funnel/funnel-view';
...
export default function FunnelPage() {
  ...
  const { product: productNoWidgets } = useGetProductGtin(gtin);
  ...
  }, [gtin, productNoWidgets, liveProduct, company, company.id, router, show]);
